...
{{- fail "vmagentRemote.enabled=true needs a metrics source: set prometheus.enabled=true to scrape mg-exporter, or scrapeMemgraphDirectly=true to scrape Memgraph's OpenMetrics endpoint directly (no exporter)." -}}
{{- end -}}
