...
| `service.loadBalancer.type`                                | Kubernetes service type                                                                                                          | `LoadBalancer`                           |
| `service.loadBalancer.enableBolt`                          | Enable Bolt protocol                                                                                                             | `true`                                   |
| `service.loadBalancer.enableWebsocketMonitoring`           | Enable WebSocket monitoring                                                                                                      | `false`                                  |
| `service.loadBalancer.enableHttpMonitoring`                | Enable HTTP monitoring                                                                                                           | `false`                                  |
| `service.loadBalancer.annotations`                         | Annotations to add to the service                                                                                                | `{}`                                     |
| `service.loadBalancer.labels`                              | Labels to add to the service                                                                                                     | `{}`                                     |
...
| `service.loadBalancer.loadBalancerSourceRanges`            | Restricts traffic through the cloud-provider load-balancer to the specified client IPs. Must be supported by the provider        | `null`                                   |
